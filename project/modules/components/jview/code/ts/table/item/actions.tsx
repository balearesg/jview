...
export function Actions({ item }): JSX.Element {
    ...
    if (permissions && typeof permissions === "object") {
        ...
        isEdit = !!permission.writeP && (permissions.additional ? item.stateId !== permissions.additional : true);
    ...
    return (
        <td>
            <div className="d-flex align-center actions-jview">
                ...
                {!!actions.delete && isDelete && <IconButton icon="delete" data-action="delete" onClick={handleClick} />}
                {!!actions.edit && <IconButton data-action="edit" icon={icon} onClick={handleClick} />}
            </div>
        </td>
    );
}
